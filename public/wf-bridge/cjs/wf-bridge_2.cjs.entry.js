...
const core = require('./core-394afd1e.js');
...
const WFTestComponent = class {
    ...
    render() {
        return (core.h("div", null, "Hello World!", core.h("wf-button", { type: "button", variant: "primary", onClick: this.handleClick }, core.h("span", null, "logCallback")), core.h("wf-select", null, core.h("wf-select-option", { name: "Option 1", value: "1" }), core.h("wf-select-option", { name: "Option 2", value: "2" }), core.h("wf-select-option", { name: "Option 3", value: "3", disabled: true }))));
    }
};

exports.wf_bridge = WFBridge;
exports.wf_test_component = WFTestComponent;
