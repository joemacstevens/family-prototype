...
var WfAccordion = /** @class */ (function () {
    function WfAccordion(hostRef) {
        registerInstance(this, hostRef);
    }
    WfAccordion.prototype.render = function () {
        return (h("div", { class: "accordion" }, h("slot", null)));
    };
    Object.defineProperty(WfAccordion, "style", {
...
export { WfAccordion as wf_accordion };
