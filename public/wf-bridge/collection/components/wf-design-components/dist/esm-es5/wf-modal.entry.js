...
var WfModal = /** @class */ (function () {
    function WfModal(hostRef) {
    ...
    WfModal.prototype.handleCloseRequest = function (event) {
        event.stopPropagation();
        this.close();
    };
    WfModal.prototype.handleGlobalScroll = function (opened) {
        opened ? disableBodyScroll(this.modalDialog) : enableBodyScroll(this.modalDialog);
    };
    WfModal.prototype.close = function () {
        this.opened = false;
        this.modalClose.emit();
    };
    WfModal.prototype.renderHeader = function () {
    ...
    WfModal.prototype.render = function () {
        var _this = this;
        var _a = this, opened = _a.opened, buttonSize = _a.buttonSize;
        return opened ? (h("div", { class: "modal" }, h("div", { class: "modal-backdrop", onClick: this.close.bind(this) }), h("div", { ref: function (el) { return (_this.modalDialog = el); }, class: "modal-dialog" }, h("slot", { name: "header" }, this.header ? this.renderHeader() : ''), h("main", { class: "modal-body" }, h("slot", null)), h("footer", { class: "modal-footer" }, h("slot", { name: "footer" }, h("wf-button", { onClick: this.handleCloseRequest.bind(this), size: buttonSize }, "Close")))))) : null;
    };
    Object.defineProperty(WfModal, "watchers", {
        get: function () {
            return {
