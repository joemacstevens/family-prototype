...
var queryShadowRoot = function (element, path) {
    if (!element.shadowRoot) {
        throw new Error('Element has no shadow root');
    }
    var selectors = path.split('>>');
    return selectors.reduce(function (previousElement, currentSelector) {
        return previousElement.querySelector(currentSelector);
    }, element.shadowRoot);
};
var makeSiblings = function (element, other) {
    element.parentNode.append(other);
};
var appendToBody = function (element) {
    document.querySelector('body').append(element);
};
var createSpy = function (target, container) {
    var spy = document.createElement('wf-spy');
    spy.target = target;
    if (container) {
...
var getElementsFromSlot = function (element, selector) {
    var slot = element.shadowRoot.querySelector(selector);
