...
export function scrollContainer(element, container) {
...
export function handleKeyboardControl(e, itemClass, focusClass, itemsList, focusedElToClick, additionalElements = []) {
