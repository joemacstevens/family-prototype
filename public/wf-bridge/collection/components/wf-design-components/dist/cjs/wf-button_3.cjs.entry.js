...
const WfButton = class {
    constructor(hostRef) {
        ...
        this.wfClick = core.createEvent(this, "wfClick", 7);
...
const WfDropdown = class {
    constructor(hostRef) {
        ...
        this.toggleDropdown = (ev) => {
            ...
            switch (this.dropdownParent.dataset.dropdown) {
                case types.DropdownTriggerType.OPEN_ONLY:
                    this.opened = true;
                    break;
                case types.DropdownTriggerType.OPEN_ONLY_WITH_ICON:
                    this.opened = ev
                        .composedPath()
        ...
        this.toggleTrigger = (ev) => {
            ...
            if (targetElement.dataset.dropdownTrigger === undefined)
                return;
            this.opened =
                targetElement.dataset.dropdownTrigger === types.DropdownTriggerType.OPEN_ONLY ? true : !this.opened;
        };
        this.checkPlacement = () => {
        ...
        this.docToggle = core.createEvent(this, "toggle", 7);
        this.docWfToggle = core.createEvent(this, "wfToggle", 7);
    }
    componentDidLoad() {
    ...
    handleKeydown(ev) {
        if (ev.key === types.KeyValue.ESC_KEY && this.opened) {
            ev.preventDefault();
            this.closeSelect();
        }
    }
    ...
    render() {
        ...
        return (core.h("div", { ref: (el) => (this.dropdown = el), class: dropdownClasses }, core.h("slot", null)));
    }
    get host() { return core.getElement(this); }
    static get watchers() { return {
        "opened": ["handleOpenedChange"]
    }; }
    static get style() { return ".dropdown{position:fixed;z-index:var(--select-z-index,1000);display:none}.dropdown-opened{display:block;min-width:var(--dropdown-min-width,100px)}.dropdown-aligned{max-width:var(--dropdown-max-width);width:var(--dropdown-width,auto)}"; }
};
__decorate([
...
const WfInput = class {
    constructor(hostRef) {
        ...
        this.setInputLeftPadding = () => {
            ...
            const paddingSum = parseInt(paddingLeft, 2) + utils.removePX(prefixWidth) + 12;
            input.style.paddingLeft = utils.setPX(paddingSum);
        };
        ...
        this.iconClick = core.createEvent(this, "iconClick", 7);
        this.wfFocus = core.createEvent(this, "wfFocus", 7);
        this.wfBlur = core.createEvent(this, "wfBlur", 7);
        this.wfClick = core.createEvent(this, "wfClick", 7);
        ...
        this.docWfInput = core.createEvent(this, "wfInput", 7);
        this.docFocus = core.createEvent(this, "focus", 7);
        this.docBlur = core.createEvent(this, "blur", 7);
        this.docClick = core.createEvent(this, "click", 7);
    }
    ...
    componentWillLoad() {
        ...
        this.inputId = `form-element-${utils.generateUniqueId()}`;
    }
    ...
    renderLockedIcon() {
        ...
        return (locked && core.h("wf-icon", { class: iconClasses, size: lockedIconSize, name: lockedIcon }));
    }
    renderLabel() {
        ...
        return (core.h("label", { class: labelClasses, htmlFor: inputId }, displayLabel, (!!error || !!required) && core.h("span", { class: asteriskClasses }, "*")));
    }
    render() {
        ...
        return (core.h("wf-tooltip", Object.assign({}, utils.prepareErrorTooltip(error, errorMessage)), core.h("div", { class: containerClasses }, (!!label || !!caption) && this.renderLabel(), core.h("div", { class: "form-control-wrapper" }, !!prefixLabel && core.h("span", { class: "prefix" }, prefixLabel), this.renderLockedIcon(), core.h("input", Object.assign({}, inputAttributes)), !!icon && (core.h("div", { class: iconClasses, onClick: handleIconClick }, core.h("wf-icon", { size: iconSize, name: icon })))), !!description && core.h("div", { class: "form-control-description" }, description), utils.showErrorMessage(error, errorMessage) && (core.h("div", { class: "form-control-error-message", innerHTML: errorMessage.text })))));
    }
    get host() { return core.getElement(this); }
    static get watchers() { return {
        "type": ["handleType"],
...
exports.wf_button = WfButton;
exports.wf_dropdown = WfDropdown;
exports.wf_input = WfInput;
