...
const svg = require('./svg-51cee06b.js');
...
const WfActionIcon = class {
    ...
    async componentWillRender() {
        ...
        try {
            this.svgContent = await svg.getIconBody(name, size);
        }
        catch (e) {
            this.svgContent = '';
            console.error(e);
    ...
    render() {
        ...
        return svgContent ? (core.h("div", { class: iconClasses }, core.h("button", { type: "button", onClick: handleClick, innerHTML: svgContent }))) : null;
    }
...
exports.wf_action_icon = WfActionIcon;
