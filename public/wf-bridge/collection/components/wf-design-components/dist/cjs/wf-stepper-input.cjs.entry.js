...
const WfStepperInput = class {
    constructor(hostRef) {
        ...
        this.docStepperChange = core.createEvent(this, "stepperChange", 7);
        this.docWfStepperChange = core.createEvent(this, "wfStepperChange", 7);
    }
    handleKeyDown(event) {
    ...
    renderLabel(id) {
        ...
        return (core.h("label", { class: labelClasses, htmlFor: `form-element-${id}`, onClick: this.focusStepper }, displayLabel, !!error && core.h("span", { class: asteriskClasses }, "*")));
    }
    renderLockedIcon() {
    ...
    render() {
        ...
        return (core.h("wf-tooltip", Object.assign({}, utils.prepareErrorTooltip(error, errorMessage)), core.h("div", { class: containerClasses }, (!!label || !!caption) && this.renderLabel(inputId), core.h("div", { class: "form-control-wrapper" }, core.h("div", { class: stepperClasses, tabindex: "1", id: `form-element-${inputId}` }, this.renderLockedIcon(), core.h("input", { disabled: true, class: "input-stepper-data", value: value }), this.swipeUpAvailable() && (core.h("wf-action-icon", { key: "arrowUp", size: arrowIconSize, name: arrowUpIcon, variant: variant === 'inverse' ? variant : undefined, class: `input-arrow input-arrow-${arrowIconSize} up`, onClick: this.swipeUp })), this.swipeDownAvailable() && (core.h("wf-action-icon", { key: "arrowDown", size: arrowIconSize, name: arrowDownIcon, variant: variant === 'inverse' ? variant : undefined, class: `input-arrow input-arrow-${arrowIconSize} down`, onClick: this.swipeDown })))), !!description && core.h("div", { class: "form-control-description" }, description), utils.showErrorMessage(error, errorMessage) && (core.h("div", { class: "form-control-error-message", innerHTML: errorMessage.text })))));
    }
...
exports.wf_stepper_input = WfStepperInput;
