...
const WfTooltip = class {
    constructor(hostRef) {
        ...
        this.updatePosition = () => {
            ...
            if (!opened || !tooltipEl.classList.contains('show'))
                return;
            const newPlacement = errorMessages.checkElementPosition(triggerEl, tooltipEl, defaultScreenGrid, distance, this.getDefaultSpaces());
            this.tryAdjustSpaces(newPlacement.spaces);
            tooltipEl.style.top = utils.setPX(newPlacement.placement.top);
            tooltipEl.style.left = utils.setPX(newPlacement.placement.left);
    ...
    getElementsFromSlot() {
        const slotEl = errorMessages.queryShadowRoot(this.host, '.tooltip-trigger>>slot');
    ...
    render() {
        ...
        const tooltipHeader = header ? core.h("h6", { class: "tooltip-header" }, header) : null;
        const tooltipText = text ? core.h("div", { class: "tooltip-text" }, text) : null;
        return (core.h("div", null, core.h("div", { class: triggerClasses }, core.h("slot", null)), core.h("div", { class: "tooltip-wrapper" }, core.h("div", { class: classes }, core.h("span", { class: "arrow-mask" }, core.h("span", { class: "arrow-pointer" })), core.h("div", { class: "tooltip-content-inner-wrapper" }, tooltipHeader, core.h("slot", { name: "content" }, tooltipText))))));
    }
...
exports.wf_spy = WfSpy;
exports.wf_tooltip = WfTooltip;
