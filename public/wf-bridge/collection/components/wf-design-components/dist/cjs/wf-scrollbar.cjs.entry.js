...
const index$1 = require('./index-f06483ad.js');
...
const observeResize = (element, callback) => {
    const observer = new index(callback);
    observer.observe(element);
};

const observeMutation = (element, callback, options) => {
    const observer = new MutationObserver(callback);
    observer.observe(element, options);
};

const WfScrollbar = class {
    constructor(hostRef) {
        ...
        this.setContentHeight = index$1.debounce((parent) => {
    ...
    addIntersectionObserver(element, parent) {
        observeIntersection.observeIntersection(element, (entries) => {
    ...
    render() {
        ...
        return (core.h("div", { class: "scroll-element", style: Object.assign({}, combinedStyles) }, core.h("slot", null)));
    }
    get host() { return core.getElement(this); }
};

exports.wf_scrollbar = WfScrollbar;
