...
const WfMultiselectDropdown = class {
    ...
    handleKeyDown(e) {
        ...
        if (optionsList) {
            ...
            keyboardControl.handleKeyboardControl(e, optionClass, focusClass, optionsList, focusedElToClick, Array.from(host.shadowRoot
    ...
    handleOptionsUpdate(newValue, oldValue) {
        ...
        this.multiselectDropdownOptions = this.sortOptions(this.filterUniqueOptions(utils.clonedeep(newValue)));
        this.currentOptionsState = JSON.stringify(this.multiselectDropdownOptions);
        this.updateSelectedOptions();
        if (oldValue)
            this.showSelectedOptions();
    ...
    renderMultiselectDropdownOptions() {
        ...
        const selectAllAttributes = {
            ...
            onWfChange: utils.stopPropagation,
        };
        ...
        return (core.h("div", { class: "multiselect-dropdown-options-wrapper" }, filteredOptions.length === 0 ? (core.h("div", { class: "multiselect-dropdown-option-not-found" }, "Cannot be found")) : (core.h("div", { class: "multiselect-dropdown-options-list" }, searchStr.length === 0 && (core.h("div", { class: "multiselect-dropdown-option multiselect-dropdown-select-all" }, core.h("wf-checkbox", Object.assign({}, selectAllAttributes, { onClick: () => this.handleSelectAllClick(allSelected), onChange: utils.stopPropagation })))), filteredOptions.map((option) => (core.h("div", { class: "multiselect-dropdown-option" }, core.h("wf-checkbox", Object.assign({}, optionAttributes(option), { onClick: () => this.handleCheckboxClick(option), onChange: utils.stopPropagation })))))))));
    }
    render() {
        ...
        return (core.h("div", { class: "dropdown-multiselect-dropdown" }, core.h("div", { class: "dropdown-trigger" }, !!label ? (core.h("label", { "data-dropdown-trigger": true, class: "form-label" }, label, !!error || (!!required && core.h("span", { class: asteriskClasses }, "*")))) : null, core.h("wf-input", Object.assign({ "data-dropdown": types.DropdownTriggerType.OPEN_ONLY_WITH_ICON, icon: "wf-arrow-down", class: "filter-selected-options" }, inputAttributes, { ref: (el) => (this.selectedOptionsElement = el) }))), core.h("wf-dropdown", { ref: (el) => (this.dropdown = el), "scroll-sensitive": "false", disabled: disabled, adjustHeight: true }, core.h("div", { class: "multiselect-dropdown" }, this.renderMultiselectDropdownOptions(), core.h("div", { class: "multiselect-dropdown-footer" }, core.h("wf-button", { onClick: () => {
                this.closeFilter();
            }, variant: "link", size: buttonSize }, "Cancel"), core.h("wf-button", { onClick: this.handleSave, size: buttonSize }, "Apply"))))));
    }
...
exports.wf_multiselect_dropdown = WfMultiselectDropdown;
