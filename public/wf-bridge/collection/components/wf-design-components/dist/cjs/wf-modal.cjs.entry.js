...
const blockScroll = require('./block-scroll-c6af2015.js');
...
const WfModal = class {
    ...
    handleGlobalScroll(opened) {
        opened ? blockScroll.disableBodyScroll(this.modalDialog) : blockScroll.enableBodyScroll(this.modalDialog);
    }
    close() {
        this.opened = false;
    ...
    renderHeader() {
        return (core.h("header", { class: "modal-header" }, core.h("button", { type: "button", class: "close", "aria-label": "Close", onClick: this.handleCloseRequest.bind(this) }, core.h("span", { "aria-hidden": "true" }, "\u00D7")), this.header));
    }
    render() {
        const { opened, buttonSize } = this;
        return opened ? (core.h("div", { class: "modal" }, core.h("div", { class: "modal-backdrop", onClick: this.close.bind(this) }), core.h("div", { ref: (el) => (this.modalDialog = el), class: "modal-dialog" }, core.h("slot", { name: "header" }, this.header ? this.renderHeader() : ''), core.h("main", { class: "modal-body" }, core.h("slot", null)), core.h("footer", { class: "modal-footer" }, core.h("slot", { name: "footer" }, core.h("wf-button", { onClick: this.handleCloseRequest.bind(this), size: buttonSize }, "Close")))))) : null;
    }
...
__decorate([
    customEventEmitter.PrefixEvent({ eventName: 'close' })
], WfModal.prototype, "modalClose", void 0);

exports.wf_modal = WfModal;
