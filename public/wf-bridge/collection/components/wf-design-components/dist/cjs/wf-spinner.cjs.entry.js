...
const WfSpinner = class {
    ...
    setErrorTimeout() {
        ...
        this.errorTimeoutHandler = utils.setupTimeout(() => {
            if (errorTimeout === 0)
                return;
            this.timeoutWarningState = false;
    ...
    async setSpinner() {
        ...
        if (delay !== 0) {
            this.delayTimeoutHandler = utils.setupTimeout(() => {
    ...
    setTimers() {
        ...
        if (warningTimeout === 0 && errorTimeout === 0)
            return;
        this.warningTimeoutHandler = utils.setupTimeout(() => {
            if (warningTimeout !== 0)
    ...
    render() {
        ...
        return visible ? (core.h("div", { class: "spinner-wrapper" }, !timeoutErrorState ? (core.h("svg", { class: "spinner-graphic", viewBox: "0 0 60 60", preserveAspectRatio: "xMidYMid" }, core.h("circle", { class: "spinner-background-ring", cx: "30", cy: "30", r: "24", "stroke-linecap": "round", fill: "none" }), core.h("circle", { class: "spinner-foreground-ring", cx: "30", cy: "30", r: "24", "stroke-linecap": "round", fill: "none" }))) : (''), timeoutWarningState ? core.h("span", { class: "spinner-msg" }, timeoutWarningMsg) : '', timeoutErrorState ? core.h("span", { class: "spinner-msg" }, timeoutErrorMsg) : '')) : null;
    }
