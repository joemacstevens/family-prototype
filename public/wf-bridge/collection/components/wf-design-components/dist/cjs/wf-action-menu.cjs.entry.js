...
const WfActionMenu = class {
    constructor(hostRef) {
        ...
        this.parsedItems = [];
        this.mappedItems = [];
        this.docSelect = core.createEvent(this, "select", 7);
        this.docWfSelect = core.createEvent(this, "wfSelect", 7);
    }
    componentWillLoad() {
    ...
    renderItem(item, enableClickEvent = true) {
        ...
        return (core.h("button", { class: itemClasses, onClick: enableClickEvent && this.handleItemClick.bind(this, item) }, !!item.icon && (core.h("wf-icon", { class: "action-menu-icon", size: item.iconSize || 'xs', name: item.icon })), core.h("span", null, item.title)));
    }
    renderGroup(item) {
        ...
        return (core.h("wf-flyout", { class: "action-menu-child-flyout", "trigger-tab-index": "-1", level: 2, overlap: overlap, "no-arrow": noArrow, trigger: childTrigger, placement: subPlacement }, core.h("div", { slot: "trigger" }, renderItem(item, false)), core.h("div", { class: menuClasses }, item.items.map((item) => renderItem.call(this, item, true)))));
    }
    ...
    render() {
        ...
        return (core.h("wf-flyout", { opened: this.opened, "enable-open-changed-event": true, overlap: overlap, trigger: trigger, placement: placement }, core.h("slot", { slot: "trigger", name: "trigger" }), core.h("div", { class: menuClasses, style: {
...
exports.wf_action_menu = WfActionMenu;
