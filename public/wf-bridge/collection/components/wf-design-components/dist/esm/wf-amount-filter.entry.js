...
const WfAmountFilter = class {
    ...
    render() {
        ...
        return (h("div", { class: "amount-filter" }, h("div", { class: "dropdown-trigger" }, !!label ? (h("label", { "data-dropdown-trigger": true, class: "form-label" }, label, (!!error || !!required) && h("span", { class: asteriskClasses }, "*"))) : null, h("wf-input", Object.assign({ ref: (el) => (this.triggerInput = el) }, inputAttributes))), h("wf-dropdown", { ref: (el) => (this.dropdown = el), alignWithParent: false, disabled: disabled }, h("div", { class: "date-picker-content" }, h("ul", { class: "date-picker-list" }, this.renderListItems()), h("div", { class: "date-picker-calendar-control" }, h("div", { class: "date-picker-range" }, h("wf-input", Object.assign({ ref: (el) => (this.innerInput = el) }, innerInputAttributes))), h("div", { class: "date-picker-footer" }, h("wf-button", { variant: "link", onClick: this.cancelFilter, size: buttonSize }, "Cancel"), h("wf-button", { onClick: this.handleApplyButtonClick, size: buttonSize }, "Apply")))))));
    }
