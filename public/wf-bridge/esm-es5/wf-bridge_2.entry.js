...
window.config = {
    presets: {
        drawerLeft: function (position) {
            var config = { start: 0, end: 0 };
        ...
        drawerBottom: function (position) {
            var config = { start: 0, end: 0 };
    ...
    agGridLicenseKey: '[TRIAL]_10_April_2020_[v2]_MTU4NjQ3NjgwMDAwMA==4723e223afba4b709ced674df3827698',
};
var waitUntilPresent = function (selector) {
...
var waitUntilHydrated = function (element) {
    return new Promise(function (resolve) {
        var id = setInterval(function () {
...
var defineAlias = function (tagName, aliasName) { return __awaiter(void 0, void 0, void 0, function () {
    var element, body;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                element = document.createElement(tagName);
                return [4 /*yield*/, waitUntilPresent('body')];
            case 1:
                body = _a.sent();
                element.style.display = 'none';
                body.append(element);
                return [4 /*yield*/, waitUntilHydrated(element)];
            case 2:
                _a.sent();
                window.customElements.define(aliasName, /** @class */ (function (_super) {
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var _i, _a, _b, tagName, aliasName;
    return __generator(this, function (_c) {
        for (_i = 0, _a = Object.entries(aliases); _i < _a.length; _i++) {
            _b = _a[_i], tagName = _b[0], aliasName = _b[1];
            defineAlias(tagName, aliasName);
        }
        return [2 /*return*/];
    });
}); })();
window.config = __assign(__assign({}, (window.config ? window.config : {})), { assets: {
        // common icons
...
var WF_FONTS_SRC = "css/fonts.css";
var WF_SKINS_PATH = "skins";
var WF_SKINS_STYLES_SRC = "styles.css";
var WF_SKINS_ASSET_CONFIG_SRC = "scripts.js";
var WF_STYLES_SRC = "wf-bridge/collection/components/wf-design-components/dist/wf-styles.css";
var WF_DESIGN_COMPONENT_MODULE_SRC = "wf-bridge/collection/components/wf-design-components/dist/wf-design-components/wf-design-components.esm.js";
var WF_DESIGN_COMPONENT_SRC = "wf-bridge/collection/components/wf-design-components/dist/wf-design-components/wf-design-components.js";
function getBaseUrl() {
    var bridgeScript = document.querySelector('script[src*="wf-bridge.js"]');
    var url = new URL(bridgeScript.src);
...
function updateAssetConfigs(theme) {
    var keys = Object.keys(window.config.assets);
    var baseUrl = getBaseUrl();
    keys.forEach(function (key) {
        var path = window.config.assets[key];
        if (theme !== 'ubs') {
...
var WFBridge = /** @class */ (function () {
    function WFBridge(hostRef) {
        registerInstance(this, hostRef);
        this.theme = "ubs";
    }
    WFBridge.prototype.componentWillLoad = function () {
    ...
    WFBridge.prototype.componentDidRender = function () {
        var children = Array.prototype.slice.call(this.host.children);
        children.length > 0 &&
            children.forEach(function (element) {
                Object.entries(WFCallbacks).forEach(function (_a) {
                    var callbackName = _a[0], callback = _a[1];
                    element[callbackName] = callback;
                });
            });
    };
    WFBridge.prototype.render = function () {
        return (h("div", null, h("slot", null)));
    };
    Object.defineProperty(WFBridge.prototype, "host", {
...
var WFTestComponent = /** @class */ (function () {
    function WFTestComponent(hostRef) {
        var _this = this;
        registerInstance(this, hostRef);
        this.handleClick = function () {
            _this.logCallback && _this.logCallback();
        };
    }
    WFTestComponent.prototype.componentDidLoad = function () {
        this.onComponentLoaded();
    };
    WFTestComponent.prototype.render = function () {
